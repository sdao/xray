...
// Notice multiple symbol definitions, standard-allowed in host code
...
// Variables necessary to perform phong shading. Notice that the prd variable (that was set as the
// ray payload in rtTrace) is also available here to get the final color result
